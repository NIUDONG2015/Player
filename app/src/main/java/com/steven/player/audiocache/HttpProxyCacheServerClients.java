...
import com.steven.player.audiocache.file.FileCache;
...
final class HttpProxyCacheServerClients {
    ...
    private final String TAG = HttpProxyCacheServerClients.class.getName();
    ...
    public void registerCacheListener(CacheListener cacheListener) {
        if(!listeners.contains(cacheListener)) listeners.add(cacheListener);
    }
    ...
    public void unregisterCacheListener(CacheListener cacheListener) {
        ...
        if(listeners.size() == 0) {
            shutdown();
            Log.d(TAG, "shutdown HttpProxyCache, the url: "+ url);
        }
    }
    ...
    public int getCacheListenerCount(){
