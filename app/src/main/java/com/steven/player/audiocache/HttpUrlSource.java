...
public class HttpUrlSource implements Source {
	private final String TAG = HttpUrlSource.class.getName();
    ...
    private void fetchContentInfo() throws ProxyCacheException {
        Log.d(TAG, "Read content info from " + url);
        ...
        try {
            ...
            Log.i(TAG, "Content info for `" + url + "`: mime: " + mime + ", content-length: " + length);
        } catch (IOException e) {
            Log.e(TAG, "Error fetching info from " + url, e);
        } finally {
